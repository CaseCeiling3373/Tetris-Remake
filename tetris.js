...
class GameBoard {
    ...
    constructor(){
        ...
        this.divMap = [];
        for(var i = 0; i < BOARDHEIGHT; i++){
            this.divMap.push([null, null, null, null, null, null, null, null, null, null]);
        }
    ...
    clearLines(){
        ...
        for(var row = BOARDHEIGHT - 1; row >= 0; row--){
            ...
            if(clear){
                ...
                this.divMap.unshift([null, null, null, null, null, null, null, null, null, null]);
